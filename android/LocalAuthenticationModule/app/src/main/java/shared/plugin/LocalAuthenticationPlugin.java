...
public class LocalAuthenticationPlugin extends Plugin {

    public static final String PLUGIN_GROUP_LOCAL_AUTHENTICATION = "localauthentication";
    ...
    public void startAuthentication(String message) {
